...
import { updateComponente as dbUpdateComponente } from "@/lib/database/equipos";
...
export async function PATCH(
  ...
  try {
    ...
    await dbUpdateComponente(id, updates);
    return NextResponse.json({ success: true });
  } catch (error: any) {
    console.error(`/api/equipos/componentes/${params?.id} PATCH error:`, error);
