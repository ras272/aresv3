...
import { GraduationCap, AlertCircle, ArrowRight, Wrench } from 'lucide-react'
import { useRouter } from 'next/navigation'

export default function CapacitacionesDisabledPage() {
          ...
          <CardContent className="p-8 text-center space-y-6">
            ...
            <div className="space-y-3">
              ...
              <p className="text-gray-600">
                El sistema de <strong>Capacitaciones</strong> ha sido desactivado temporalmente por solicitud del usuario
              </p>
