  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        // Animaciones personalizadas para theme toggle
        'theme-slide': {
      ...
      animation: {
        ...
        // Animaciones personalizadas para theme toggle
        'theme-slide': 'theme-slide 0.6s ease-out',
        'theme-glow': 'theme-glow 2s ease-in-out infinite',
        'icon-bounce': 'icon-bounce 0.8s ease-in-out',
        'switch-slide': 'switch-slide 0.4s ease-in-out',
      },
    },
  },
