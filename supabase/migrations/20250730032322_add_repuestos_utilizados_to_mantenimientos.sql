...
ADD COLUMN IF NOT EXISTS repuestos_utilizados JSONB DEFAULT '[]'::jsonb;
...
CREATE INDEX IF NOT EXISTS idx_mantenimientos_repuestos_utilizados ON public.mantenimientos USING GIN (repuestos_utilizados);
